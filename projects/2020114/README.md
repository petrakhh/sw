...
| 2 | [Γραμμή εντολών](https://epidrome.github.io/teaching/cli) (systemd) και [διαδικασία συνεργασίας με pull request στον οργανισμό της ομάδας σας](https://epidrome.github.io/teaching/team) |[σύνδεσμος](https://github.com/courses-ionio/sw/discussions/1284)| |
...
Για την υλοποίηση του δεύτερου παραδοτέου χρησιμοποίησα το ntfy ώστε να στείλω ένα notification στο κινητό μου για τον χρόνο εκτέλεσης μέσα από ένα python script που έτρεξα. Δεν κατάφερα να λάβω ειδοποίηση μέσω της εφαρμογής. Επιπλέον, δεν χρησημοποιήθηκε το asciinema  διότι υπήρξε μια αδυναμία εγκατάστασης.

Οι εντολές στο τερματικο:
